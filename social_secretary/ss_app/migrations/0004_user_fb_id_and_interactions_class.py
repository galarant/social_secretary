...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ss_app_interactions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ss_app.Contacts'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('interaction_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('interaction_dir', self.gf('django.db.models.fields.BinaryField')()),
            ('interaction_time', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal(u'ss_app', ['Interactions'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'ss_app_interactions')
